...
plan: 03
subsystem: screener
tags: [rich, progress, callback, pipeline, market-data]

# Dependency graph
requires:
  - phase: 05-cli-and-integration
    provides: "run_pipeline with on_progress callback, progress_context display, _progress helper"
provides:
...
tech-stack:
  added: []
  patterns:
    - "on_progress callback passthrough from pipeline to data-fetching functions"
...
requirements-completed: [CLI-01, OUTP-04]
