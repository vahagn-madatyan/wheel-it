...
plan: 01
subsystem: screener
tags: [finnhub, rate-limiting, api-client, fallback-chains, retry]

# Dependency graph
requires:
  - phase: 01-foundation
    provides: "config/credentials.py with require_finnhub_key(), screener/ package structure"
provides:
...
affects: [02-data-sources, 03-screening-pipeline]

# Tech tracking
tech-stack:
  added: [finnhub-python]
  patterns: [rate-limiting-via-sleep-throttle, retry-on-429-with-backoff, metric-fallback-chains]
