...
plan: 01
subsystem: config
tags: [yaml, pydantic, presets, dataclass, pytest]
...
affects: [02-data-fetching, 03-screening-pipeline, 04-output]

# Tech tracking
tech-stack:
  added: [pytest, pyyaml]
  patterns: [yaml-config-loading, pydantic-v2-validation, deep-merge, progressive-dataclass, tdd]
